...
class TransactionService {
  static async getTransactions() {
    ...
    const timeoutPromise = new Promise((_, reject) => {
      setTimeout(() => reject(new Error('Transaction fetch timed out. Please check your connection and try again.')), 10000);
    });
  ...
  static async addTransaction(transactionData, userId) {
    ...
    // Add timeout promise to prevent infinite hanging
    const timeoutPromise = new Promise((_, reject) => {
      setTimeout(() => reject(new Error('Transaction save timed out. Please check your connection and try again.')), 10000);
    });
